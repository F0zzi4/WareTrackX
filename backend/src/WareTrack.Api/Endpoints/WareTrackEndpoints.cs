...
using WareTrack.Api.Domain;
using WareTrack.Api.Services;

namespace WareTrack.Api.Endpoints;

public static class WareTrackEndpoints
{
    public static void MapWareTrackApi(this IEndpointRouteBuilder app)
    {
        var api = app.MapGroup("/api").WithTags("WareTrack");
